...
data class Vector(val x: Double, val y: Double) {
    ...
    fun rotate(radiansDegrees: Double) : Vector {
        return Vector(x*Math.cos(radiansDegrees) - y*Math.sin(radiansDegrees), x*Math.sin(radiansDegrees) + y*Math.cos(radiansDegrees))
    }
